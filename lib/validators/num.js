...
Num.prototype.validate = function (ctx) {
	var wasTransformed = ctx.isTransfromed;
	var isValid = ctx.value != null && this.validateType(ctx) && this.validateValue(ctx);
...
Num.prototype.isTypeValid = function (ctx) {
	var isTypeValid = ctx.value.constructor == Number;
